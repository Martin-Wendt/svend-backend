...
namespace SitrepAPI.Migrations
{
    ...
    [Migration("20220301094044_seedata")]
            ...
            modelBuilder.Entity("SitrepAPI.Entities.Case", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CaseId = -2,
                            CreatedAt = new DateTimeOffset(new DateTime(1, 2, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                        ...
                        {
                            CaseId = -3,
                            CreatedAt = new DateTimeOffset(new DateTime(1, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            CaseId = -4,
                            CreatedAt = new DateTimeOffset(new DateTime(1, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            CaseId = -5,
                            CreatedAt = new DateTimeOffset(new DateTime(1, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
